    ...
    <div>
        <div class="repeater"> 
            <div class="cst_quiz formcontrol">
                <label><?php if($custom_labels['quiz']!= '') echo $custom_labels['quiz']; else "Quiz"; ?> Title</label>
                <input type="text" name="quiztitle" id="quiztitle"  placeholder="<?php if($custom_labels['quiz']!= '') echo $custom_labels['quiz']; else "Quiz"; ?> title">
            </div>
            <div class="fomcontrol">
                <label><?php if($custom_labels['quiz']!= '') echo $custom_labels['quiz']; else "Quiz"; ?> Description</label>
