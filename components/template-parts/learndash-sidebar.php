...
<div class="lms-topic-sidebar-wrapper <?php echo $side_panel_state_class;?>">
	<div class="lms-topic-sidebar-data">
        ...
        <div class="lms-topic-sidebar-course-navigation">
			...
			<?php 
			$title = get_the_title($parent_course->ID);
			$backto_courses = get_site_url()."/courses/".strtolower(str_replace(" ", "-", $title));
			?>
                <a title="<?php echo $parent_course_title; ?>" href="<?php echo $backto_courses; ?>" class="course-entry-link"><span><i class="bb-icons bb-icon-chevron-left"></i><?php echo sprintf( esc_html_x('Back to %s', 'link: Back to Course', 'buddyboss-theme'), LearnDash_Custom_Label::get_label( 'course' ) );?></span></a>
