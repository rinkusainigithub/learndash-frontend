            ...
            <div class="table-title">
                <div class="row create_class">
					...
					<div class="col-sm-6 crearet_class_btn">
						...
						<button type="button"><i class="material-icons">&#xE147;</i> <span>Add New <?php echo $ld_custom_quiz; ?></span></button>
						</a>
					</div>
                </div>
            </div>
            <table id="class-table" class="table table-striped table-hover">
                <thead>
                    <tr>
                        ...
                        <th><?php echo $ld_custom_lessons;?> Assigned</th>
                        <th>Modified By</th>
                        <th>Action</th>
                    </tr>
                </thead>
				...
				if($quizs){
					...
					?>
						...
						<td><a href="<?php echo $cst_frnt_quiz_page; ?>?quiz_id=<?php echo $quiz->ID; ?>" class="edit" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Edit"></i></a></td>
                    </tr>
					<?php }
				}
			?>
