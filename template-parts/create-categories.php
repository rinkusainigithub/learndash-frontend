...
<form  name="cst_category" method="post" class="cst_category">
	<div class="formcontrol">
		<label>Category</label>
		<input type="text" name="categoryId" id="categoryId">
		<span id="categoryValidation" style="color:red; display:none">Required*</span>
	</div>
	<br />
	<input type="submit" name="categorySubmit" class="categorySubmit">
</form>